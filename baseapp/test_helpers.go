...
func (app *BaseApp) SimCheck(txEncoder sdk.TxEncoder, tx sdk.Tx) (sdk.GasInfo, *sdk.Result, error) {
	...
	gasInfo, result, _, err := app.RunTx(nil, execModeCheck, bz, tx, -1, nil, nil)
	return gasInfo, result, err
}

// Simulate executes a tx in simulate mode to get result and gas info.
func (app *BaseApp) Simulate(txBytes []byte) (sdk.GasInfo, *sdk.Result, error) {
	gasInfo, result, _, err := app.RunTx(nil, execModeSimulate, txBytes, nil, -1, nil, nil)
	return gasInfo, result, err
}
...
func (app *BaseApp) SimDeliver(txEncoder sdk.TxEncoder, tx sdk.Tx) (sdk.GasInfo, *sdk.Result, error) {
	...
	gasInfo, result, _, err := app.RunTx(nil, execModeFinalize, bz, tx, -1, nil, nil)
	return gasInfo, result, err
}
